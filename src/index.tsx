 ...
 * @param: imagePropList: 图片列表数据，listChange: 是否改变图片列表，containerWidth: 容器宽度
 **/
import React, { useState, useEffect } from 'react';
import ImageComponent, { ImageData } from './ImageComponent';
...
const ImageList = (props: IProps) => {
  ...
  let imageHtml: any = <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}><div/>暂无图片</div>;
